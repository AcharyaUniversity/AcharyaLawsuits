...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios(
      `https://api-prod-acharyainstitutes.in/Acharya_University_Mess/api/regenrationOfToken?legal_department_user_name=${values.username}&legal_department_user_password=${values.password}`
    )
      .then((res) => {
